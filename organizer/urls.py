...
from .views import (tag_list, tag_detail, startup_list, startup_detail, TagCreate, TagUpdate, TagDelete,
                    StartupCreate, StartupUpdate, StartupDelete, NewsLinkCreate, NewsLinkUpdate, NewsLinkDelete)
