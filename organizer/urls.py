...
from .views import tag_list, tag_detail, startup_list, startup_detail, TagCreate, TagUpdate, \
    StartupCreate, NewsLinkCreate, NewsLinkUpdate
...
urlpatterns = [
    ...
    url(r'^startup/(?P<slug>[\w\-]+)/update/$', startup_detail, name='organizer_startup_detail'),
